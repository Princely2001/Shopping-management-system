...
public class WestminsterShoppingManager implements ShoppingManager {
    ...
    public void loadProductsFromFile() {
        String filePath = "D:\\20211555\\oopcw\\Javacode\\src\\shop_cart.csv";
    ...
    public void add_Product() {
        try {
            ...
            if (new_product.equals("electronics")) {
                ...
                Electronics Electric_item = new Electronics(Product_id, Product_name, Num_ava_items, Category, price, Elec_brand, Elec_Warrenty);
                ...
                Clothing Cloth_item = new Clothing(Product_id, Product_name, Num_ava_items, Category, price, cloth_color, cloth_size);
    ...
    public void load_file() {
        try (BufferedReader shop_cart = new BufferedReader(new FileReader("D:\\20211555\\oopcw\\Javacode\\src\\shop_cart.csv"))) {
            String line = shop_cart.readLine(); // Read header line

            while ((line = shop_cart.readLine()) != null) {
                String[] values = line.split(",");
                if (values.length >= 7) {
                    String productId = values[0];
                    String productName = values[1];
    ...
    private static int getNextProductID() {
        int maxId = 0;
        String line;
        try (BufferedReader reader = new BufferedReader(new FileReader("D:\\20211555\\oopcw\\Javacode\\src\\shop_cart.csv"))) {
